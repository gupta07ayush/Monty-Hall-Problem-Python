import random
from tkinter import END, StringVar, Label, Tk, Entry
...
label2 = Label(window, text='Switched Choice').place(x=80, y=40)
label3 = Label(window, textvariable=same_choice, font=(15)).place(x=180, y=8)
label4 = Label(window, textvariable=switched_choice,
               font=(15)).place(x=180, y=40)
